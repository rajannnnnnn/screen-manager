# screentimer - its a keep track of screentime, the time will update every 3 minutes (customisaable), and displays the screentime of previous day with timeline on startup (can also view for any date)
